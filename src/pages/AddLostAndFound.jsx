...
export default function AddLostAndFound() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await LostAndFound.create(itemData);
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 p-6">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Report Lost/Found</h1>
            <p className="text-gray-600 mt-1">Help reunite lost pets and items with their owners</p>
          </div>
        </div>
