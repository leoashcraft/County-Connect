...
import { Landmark, ArrowLeft, Save, MapPin, Globe, Phone, Mail, Clock } from "lucide-react";
...
export default function AddAttraction() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate(createPageUrl(`AttractionDetail?id=${newAttraction.id}`));
    } catch (error) {
                ...
                {!formData.is_free && (
                  <div>
                    ...
                    <Textarea
                      ...
                      rows={2}
                      placeholder="Adults: $10, Children: $5, Seniors: $8"
                    />
                  </div>
                )}
              </div>
