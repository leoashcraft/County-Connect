...
import { Heart, ArrowLeft, Plus, X, Save, Clock, MapPin, Loader2 } from "lucide-react";
import { toast } from "sonner";
import { geocodeTexasAddress } from "@/utils/geocoding";

export default function AddCommunityResource() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await CommunityResource.create(resourceData);
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Who is eligible to receive services? Any income limits, residency requirements, etc."
                    rows={3}
                  />
                </div>
