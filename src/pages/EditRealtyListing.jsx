...
import { Home, ArrowLeft, Upload, X, MapPin, Loader2, DollarSign, Bed, Bath, Square, Trash2 } from "lucide-react";
import { geocodeTexasAddress } from "@/utils/geocoding";
import { toast } from "sonner";

export default function EditRealtyListing() {
  ...
  const loadData = async () => {
    try {
      ...
      if (listingId) {
        const listing = await RealtyListing.get(listingId);

        // Check if user can edit
        if (userData && (userData.id === listing.created_by || userData.role === 'admin')) {
          setFormData({
            title: listing.title || "",
            ...
            garage: listing.garage?.toString() || "",
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await RealtyListing.update(listingId, listingData);
  ...
  const handleDelete = async () => {
    ...
    try {
      await RealtyListing.delete(listingId);
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 p-6 flex items-center justify-center">
        <Card className="border-2 border-green-100 max-w-md">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-4">Please sign in to edit listings.</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">Update your property listing</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Card className="border-2 border-green-100">
            <CardContent className="p-6">
              <h2 className="text-xl font-bold mb-4">Listing Status</h2>
              <div>
