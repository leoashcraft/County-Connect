...
export default function EditRestaurant() {
  ...
  const loadRestaurant = async () => {
    try {
      ...
      const restaurantData = await Restaurant.get(restaurantId);

      // Check if user owns this restaurant
      if (restaurantData.created_by !== userData.id) {
        alert("You don't have permission to edit this restaurant");
        navigate(createPageUrl("MyRestaurants"));
        return;
      }
      ...
      // Initialize default operating hours if none exist
      const defaultHours = [
      ...
      setFormData({
        ...
        photo_urls: restaurantData.photo_urls || [],
        cuisine_types: restaurantData.cuisine_types || [],
        dietary_flags: restaurantData.dietary_flags || [],
        payment_methods: restaurantData.payment_methods || [],
        address: restaurantData.address || "",
        town: restaurantData.town || "",
        town_id: restaurantData.town_id || "",
        lat: restaurantData.lat || null,
        lng: restaurantData.lng || null,
        phone: restaurantData.phone || "",
        website: restaurantData.website || "",
        reservation_url: restaurantData.reservation_url || "",
        social_links: restaurantData.social_links || {},
        operating_hours: restaurantData.operating_hours && restaurantData.operating_hours.length > 0
          ? restaurantData.operating_hours
          : defaultHours,
        menu_sections: restaurantData.menu_sections || [],
        ...
        delivery_available: restaurantData.delivery_available || false,
        takeout_available: restaurantData.takeout_available || false,
        accepts_reservations: restaurantData.accepts_reservations || false,
        family_friendly: restaurantData.family_friendly || false,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await Restaurant.update(restaurantId, updateData);
  ...
  if (!restaurant) {
    return <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 flex items-center justify-center">
      <div className="text-center">
        ...
        <Button onClick={() => navigate(createPageUrl("MyRestaurants"))}>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 p-6">
      <div className="max-w-4xl mx-auto">
        <Button
          variant="outline"
          onClick={() => navigate(createPageUrl(`RestaurantDetail?id=${restaurantId}`))}
          className="mb-6"
        >
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">Update your restaurant profile</p>
        </div>
